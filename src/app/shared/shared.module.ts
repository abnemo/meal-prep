...
@NgModule({
  ...
  imports: [CommonModule, FlexLayoutModule, RouterModule, MaterialModules,
    FilterTextboxModule, FloatButtonModule, IngredientDialogModule, IngredientCardModule, SwipeModule],
  exports: [CommonModule, MaterialModules, FlexLayoutModule, RouterModule, HoldableDirective, RecipeListComponent,
    FilterTextboxModule, FilterPipe, FloatButtonModule, IngredientDialogModule, IngredientCardModule, SwipeModule],
})
